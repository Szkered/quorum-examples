...
// var perm = Permissions.at("0xfe0602d820f42800e3ef3f89e1c39cd15f78d283");
...
// 	perm.ProposeNode("ffhb1096ca56b9f6d004b779ae3728bf83f8e22453404cc3cef16a3d9b96608bc67c4b30db88e0a5a6c6390213f7acbe1153ff6d23ce57380104288ae19373ef","true", "true") .then (function(result) {
// 	printEvent(result);
// });
...
module.exports = (done) => {
  ...
  Permissions.deployed().then(instance => {
    perm = instance;

    return perm.ProposeNode("eehb1096ca56b9f6d004b779ae3728bf83f8e22453404cc3cef16a3d9b96608bc67c4b30db88e0a5a6c6390213f7acbe1153ff6d23ce57380104288ae19373ef","true", "true")
  }).then(result => {
